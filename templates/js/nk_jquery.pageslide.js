    ...
    return this.each(function(){
      $(this).unbind("mouseover").bind("mouseover", function(){
        function _checkA(elm) { for (; elm != null; elm = elm.parentElement) { if (elm.tagName == 'A') return true; } return false; }
          _openSlide(this);
          $("#pageslide-slide-wrap").unbind('mouseover').mouseover(function(e){ if(! _checkA(e.target)) return false; });     
          if (settings.modal != true) {
          $(document).unbind('mouseover').mouseover(function(e) { if(! _checkA(e.target)){ $(document).unbind('mouseover'); _closeSlide(e); return false } });
        }
          return false;
        }); 
    });
